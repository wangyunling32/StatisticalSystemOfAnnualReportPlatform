...
<body onload="load()" background="img/123.jpg"
	...
	<div width="90%" align="center">
               ...
               %>
                ...
                %>
						...
						<tr>
							...
							<td colspan="3" align="center"><script>
            
            
            $.each(SUBJECT[1202002], function(key,value) {
				document.write("<p>"+value + "</p>");
			});
                	
            </script> <%
                int x2=Integer.valueOf(platform.getSubject());
		...
		<form action="Update_status" style="text-align: center;" method="post">
			审核结果 <input type="hidden" checked="checked" name="pid"
				value="<%=pid %>"> <input type="submit" name="status"
				value="通过"> <input type="submit" name="status" value="不通过">
		</form>
