...
<body background="img/123.jpg"
	...
	<div>
		<a href="temp.jsp"><input type="button"
	...
	<div
		...
		<br> <br> <br> <a href="yishenhe.jsp"><input
			...
			value="已审核"></a> <a href="admin.jsp"><input type="button"
			style="background-color: #87CEFA; border-bottom: solid 1px #316a91; height: 35px; width: 150px; font-size: 20px"
			...
			<div
				...
				<div style="border: solid 1px #8a8a8a80; height: 39px;"
					...
					<div>
						...
						<div class="layui-input-inline">
							<input type="submit" value="查询" style="background-color: #F4A460"
								class="layui-btn" />
						</div>
					</div>
					<div class="layui-input-inline">
						<input type="hidden" name="approval_date" id="approval_date"
							placeholder="如：1987-05-01" lay-skin="primary" class="layui-input"
